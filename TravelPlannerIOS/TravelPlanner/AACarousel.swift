...
//  TravelPlanner
//
//  Created by ESPRIT on 27/12/2017.
...
public class AACarousel: UIView,UIScrollViewDelegate {
    ...
    fileprivate func initWithLabel() {
        ...
        let font = UIFont(name: "savoye LET", size: 22)
    ...
    fileprivate func setLayerViewFrame() {
        ...
        layerView.frame = CGRect.init(x: 0 , y: scrollView.frame.size.height - 50, width: scrollView.frame.size.width * 5, height: 50)
    ...
    fileprivate func setLabelFrame() {
        ...
        describedLabel.frame = CGRect.init(x: scrollView.frame.size.width * 2 + 10 , y: layerView.frame.size.height - 65, width: scrollView.frame.size.width - 20, height: 70)
