...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar myToolbar = (Toolbar) findViewById(R.id.my_toolbarr);
                ...
                .addOnSuccessListener(this, new OnSuccessListener<Location>() {
                    ...
                    public void onSuccess(Location location) {
                        ...
                        if (location != null) {
                            ...
                            LatLng distination = new LatLng(NavigatorData.getInstance().getNearby().getLat(), NavigatorData.getInstance().getNearby().getLng());
                            // mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(distination, 18));
                            destinationMarkers.add(mMap.addMarker(new MarkerOptions()
                                    .title(NavigatorData.getInstance().getNearby().getName())
                           ...
                           /* if (MarkerPoints.size() == 1) {
                            ...
                            // LatLngBounds zooom = new LatLngBounds(
                            //  new LatLng(origin.latitude, origin.longitude), new LatLng(distination.latitude, distination.longitude));

                            LatLngBounds.Builder builder = new LatLngBounds.Builder();
                            builder.include(origin).include(distination);

                           /* mMap.moveCamera(CameraUpdateFactory.newLatLng(origin));
                            mMap.animateCamera(CameraUpdateFactory.zoomTo(11));*/
                            CameraUpdate cameraUpdate = CameraUpdateFactory.newLatLngBounds(builder.build(), 100);
                            mMap.moveCamera(cameraUpdate);
                            //mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(builder.build(), 10));
